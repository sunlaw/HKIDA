					...
					<form>
						...
						<div class="filter-wrapper">
							<div class="filter-menu text-left">
								<button class="dropdown-toggle" type="button" id="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Please select</button>
								<div class="dropdown-menu dropdown-menu-down" aria-labelledby="dropdownMenuButton">
									<a class="dropdown-item" href="#">Professional Member</a>
									<a class="dropdown-item" href="#">Ordinary Member</a>
									<a class="dropdown-item" href="#">Corporate Member</a>
									<a class="dropdown-item" href="#">Affiliate Corporate Member</a>
									<a class="dropdown-item" href="#">Affiliate Personal Member</a>
						...
						<div class="input-wrapper">
							<input id="title" type="text" name="title" placeholder="Day">
							<input id="title" type="text" name="title" placeholder="Month">
							<input id="title" type="text" name="title" placeholder="Year">
						</div>
						<div class="divider">
						...
						<input id="title" type="text" name="title" placeholder="">
						<label>The brief description of your company</label>
